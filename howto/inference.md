...
The script assumes you have downloaded and converted the weights and saved them in the `./checkpoints` folder as described [here](#downloading-pretrained-weights). If you have the weights stored elswehere, you can pass it in as a parameter:
